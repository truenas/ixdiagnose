...
@pytest.mark.parametrize(
    "name,isdir,path,result,report,should_work",
    [
        (
            "certs",
            "/etc/certificates",
        ...
        (
            ...
            (
                ...
                [
                    {
                        "error": "/etc/certificates either does not exist or is not a directory",
...
@pytest.mark.parametrize(
    "middleware_response,results,reports",
    [
        (
            MiddlewareResponse(
        ...
        (
            MiddlewareResponse(result_key="filesystem_listdir", error="File does not exists", output=[]),
            [],
