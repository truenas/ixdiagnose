...
@pytest.mark.parametrize(
    "context,data,should_work",
    [
        (
            {"middleware_client": None, "output_dir": "/root/debug_reports/ixdiagnose/plugins/iscsi"},
            (
                [
                    {
                ...
                {
                    "key": "service",
                    "output": {"id": 7, "service": "iscsitarget", "enable": True, "state": "RUNNING", "pids": []},
                },
            ),
            False,
        ),
