...
@pytest.mark.parametrize(
    "name,raw_asset_filename,cooked_asset_filename,extension,callback",
    [
        (
            "scst.conf",
...
def test_redacted_file_metric(
    mocker, monkeypatch, name, raw_asset_filename, cooked_asset_filename, extension, callback
):
