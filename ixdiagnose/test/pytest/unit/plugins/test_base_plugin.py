...
@pytest.mark.parametrize(
    "metrics_to_execute,metric_output,metric_report",
    [
        (
            [
            ...
            ],
            {
                "key": "services_status",
                "output": [
                    {"id": 1, "service": "nfs", "enable": True, "state": "STOPPED", "pids": []},
                    {"id": 2, "service": "snmp", "enable": False, "state": "STOPPED", "pids": []},
                    {"id": 3, "service": "ssh", "enable": True, "state": "RUNNING", "pids": [2602]},
                ],
            },
            [
                {
