...
class DirectoryServices(Plugin):
    ...
    metrics = [
        ...
        MiddlewareClientMetric(
            "domain_info",
            [MiddlewareCommand("directoryservices.domain_info")],
        ...
        MiddlewareClientMetric(
            "kerberos_principal_choices",
            [MiddlewareCommand("kerberos.keytab.kerberos_principal_choices")],
        ),
        MiddlewareClientMetric(
        ...
        CommandMetric(
            ...
            [
                Command(
                    ["grep", "-iv", "ldap_default_authtok", "/etc/sssd/sssd.conf"], "Config file", serializable=False
                )
            ],
        ),
    ]
