...
class System(Plugin):
    ...
    metrics = [
        CommandMetric(
            ...
            [
                ...
                Command(
                    ...
                    "Drift rate and offset estimation for each source",
                    serializable=False,
                ),
            ...
            [
                MiddlewareCommand(
                    ...
                    format_output=remove_keys(
                        [
                            "birthday",
                            "ui_certificate.privatekey",
                            "ui_certificate.issuer.privatekey",
        ...
        MiddlewareClientMetric(
            "system_global_id",
            [MiddlewareCommand("system.global.id", result_key="System Global ID")],
        ),
        MiddlewareClientMetric(
            "system_info",
            [
