...
from ixdiagnose.utils.middleware import MiddlewareClient, MiddlewareCommand, AdminMiddlewareCommand
...
class Hardware(Plugin):
    ...
    metrics = [
        ...
        MiddlewareClientMetric(
            "jbof_config", [MiddlewareCommand("jbof.query", format_output=remove_keys(["mgmt_password"]))]
        ),
