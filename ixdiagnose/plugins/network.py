...
class Network(Plugin):
    ...
    metrics = [
        CommandMetric(
            "protocol_stats",
            [Command(["netstat", "-p", "-s"], "Statistics of All protocols", serializable=False)],
        ),
        CommandMetric(
            "ipset_ipvs_rules",
            [
    ...
    raw_metrics = [
        ...
        CommandMetric(
            "interface_statistics", [Command(["ip", "-s", "addr"], "Interface Statistics", serializable=False)]
        ),
        CommandMetric(
            "nft_rules", [Command(["nft", "-a", "list", "ruleset"], "NFTables rulesets", serializable=False)]
        ),
    ]
