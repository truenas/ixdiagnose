    ...
    metrics = [
                    ...
                    [
                        {
                            ...
                            "query-options": {
                                "select": ["audit_id", "message_timestamp", "event_data", "success"],
                                "order_by": ["-message_timestamp"],
                                "limit": 100,
                            },
                        }
        ...
        CommandMetric(
            ...
            [
                Command(
                    ["truenas_verify"],
                    "Result from truenas_verify",
                    serializable=False,
                    safe_returncodes=[],  # With no safe_returncodes we can silently run the command
                ),
                Command(["shasum", "-a", "256", "/conf/rootfs.mtree"], "sha256 rootfs.mtree", serializable=False),
                Command(["aureport"], "auditd summary report", serializable=False),
            ],
        ),
