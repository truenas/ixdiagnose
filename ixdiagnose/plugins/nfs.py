...
from .metrics import CommandMetric, DirectoryTreeMetric, FileMetric, MiddlewareClientMetric, PythonMetric
        ...
        CommandMetric(
            ...
            [
                ...
                Command(
                    ...
                    "RPC Statd Service Status",
                    serializable=False,
                    safe_returncodes=[0, 3],
                ),
                Command(
                    ["systemctl", "status", "rpc-gssd"],
                    "RPC Gssd Service Status",
                    serializable=False,
                    safe_returncodes=[0, 3],
                ),
                Command(
                    ["systemctl", "status", "gssproxy"],
                    "Gssproxy Service Status",
                    serializable=False,
                    safe_returncodes=[0, 3],
                ),
            ],
